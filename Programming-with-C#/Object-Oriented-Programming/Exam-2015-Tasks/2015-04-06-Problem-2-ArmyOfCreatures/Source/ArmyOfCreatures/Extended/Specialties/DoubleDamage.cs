namespace ArmyOfCreatures.Extended.Specialties
{
    ...
    public class DoubleDamage : Specialty
    {
        ...
        {
            if (rounds <= MinRounds || rounds > MaxRound)
            {
                throw new ArgumentOutOfRangeException("rounds", string.Format(GlobalConstants.RoundsOutOfRangeExcMsg, MinRounds, MaxRound));
            }
