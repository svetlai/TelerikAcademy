namespace ArmyOfCreatures.Extended.Specialties
{
    ...
    public class AddAttackWhenSkip : Specialty
    {
        ...
        private const string AttackToAddOutOfRangeExcMsg = "attackToAdd should be between {0} and {1}, inclusive";
        ...
        public AddAttackWhenSkip(int attackToAdd)
        {
            ...
            {
                throw new ArgumentOutOfRangeException("attackToAdd", string.Format(AttackToAddOutOfRangeExcMsg, MinDefenseToAdd, MaxDefenseToAdd));
            }
